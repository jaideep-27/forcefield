    ...
    >
      ...
      <div
        style={{
          ...
          height: 600,
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(35,138,213,0.25) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          height: 400,
          borderRadius: "50%",
          border: "3px solid rgba(57,195,23,0.15)", /* #39c317 is 57,195,23 */
          pointerEvents: "none",
        }}
      />
      {/* Dot grid */}
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(60deg, transparent 65%, rgba(214,77,33,0.04) 100%)", /* #d64d21 is 214,77,33 */
          pointerEvents: "none",
        }}
      />
            ...
            >
              <div
                style={{
                  ...
                  padding: "6px 16px",
                  borderRadius: 999,
                  border: "1px solid rgba(57,195,23,0.35)", /* Brand Green */
                  background: "rgba(57,195,23,0.08)",
                }}
              >
                <span
                  style={{
                ...
                <span
                  style={{
                    ...
                    color: "rgba(241,245,240,0.9)", /* Brand White is #f1f6f0 (241,246,240) */
            ...
            >
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  fontFamily: "var(--font-body)",
                  boxShadow: "0 8px 28px rgba(214,77,33,0.45)",
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 12px 36px rgba(214,77,33,0.6)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)";
                  (e.currentTarget as HTMLButtonElement).style.filter = "none";
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 28px rgba(214,77,33,0.45)";
                }}
              >
                Get My Player Pass
          ...
          >
            ...
            <div
              style={{
                ...
                inset: "-20px",
                borderRadius: 28,
                background: "radial-gradient(ellipse at 50% 50%, rgba(35,138,213,0.35) 0%, transparent 70%)",
                filter: "blur(24px)",
                zIndex: 0,
              }}
            />
            ...
            >
              ...
              <div
                style={{
                  position: "absolute",
                  inset: 0,
                  background: "linear-gradient(to top, rgba(10,22,40,0.5) 0%, transparent 45%)",
                }}
              />
            </div>
            ...
            >
              <div
                style={{
                  ...
                  height: 40,
                  borderRadius: 12,
                  background: "linear-gradient(135deg, #238ad5, #0d1f3c)",
                  display: "flex",
                  alignItems: "center",
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#39c317" stroke="#39c317" strokeWidth={1}>
